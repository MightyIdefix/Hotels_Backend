...
async function addRoom(hotelnavn, roomNumber_, occupied_, guestName_)
{
    guestObjectID = await getUser(guestName_);
    var newroom = {number:roomNumber_, occupied:occupied_, guests:[guestObjectID._id]};
...
//CreateHotel('TestHotel');
//addRoom('TestHotel', 222, false, 'AdminUser');
// addRoom('TestHotel', newroom2);
